...
movies.top.not.matrix= rbind(a2,a3,a4,a5,a6,a7,a8,a9,a10,a11,a12,a13,a14,a15)
save(movies.top.not.matrix,file="new_movies_dataframe.RData")




movies.top.revised=matrix(NA,nrow=140,ncol=2)
a2
a2=as.matrix(a2)
a3=as.matrix(a3)
a4=as.matrix(a4)
...
movies.top.revised=matrix(NA,ncol=2,nrow=140)
movies.top.revised[,1]= rbind(a2,a3,a4,a5,a6,a7,a8,a9,a10,a11,a12,a13,a14,a15)

movies.top.revised

for(i in 1:140){
  movies.top.revised[i,2]= (i-1)%/%10+1
}
movies.top.revised

#class(movies.top.revised[,2])

save(movies.top.revised,file="new_movies_names_asmatrix.RData")
